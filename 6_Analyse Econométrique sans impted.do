...
esttab fe1 fe2 fe3 fe4 fe5 fe6 using "`resultpath'TABREGwithin1.tex", se star(* 0.10 ** 0.05 *** 0.01) mtitles("1" "2" "3" "4" "5" "6") b(3) se(3) style(tex) drop(yr*) booktabs replace
...
esttab Steel1 Steel2 Steel3 Steel4 Steel5 Steel6 using "`resultpath'TABLEABSteelxtiv2.tex", se star(* 0.10 ** 0.05 *** 0.01) mtitles("1" "2" "3" "4" "5" "6") b(3) se(3) style(tex) booktabs replace
...
esttab AB1 AB2 AB3 AB4 AB5 AB6 using "`resultpath'TABLEAB.tex", se star(* 0.10 ** 0.05 *** 0.01) mtitles("1" "2" "3" "4" "5" "6") b(3) se(3) style(tex) drop(yr*) booktabs replace
...
esttab fe51 fe52 fe53 fe54 fe55 fe56 using "`resultpath'TABREGAVG5.tex", se star(* 0.10 ** 0.05 *** 0.01) mtitles("1" "2" "3" "4" "5" "6") b(3) se(3) style(tex) drop(yr*) booktabs replace
...
esttab Steel1 Steel2 Steel3 Steel4 Steel5 Steel6 using "`resultpath'TABLEABSteelxtiv55.tex", se star(* 0.10 ** 0.05 *** 0.01) mtitles("1" "2" "3" "4" "5" "6") b(3) se(3) style(tex) booktabs replace
...
esttab AB1 AB2 AB3 AB4 AB5 AB6 using "`resultpath'TABLEAB5.tex", se star(* 0.10 ** 0.05 *** 0.01) mtitles("1" "2" "3" "4" "5" "6") b(3) se(3) style(tex) drop(yr*) booktabs replace
